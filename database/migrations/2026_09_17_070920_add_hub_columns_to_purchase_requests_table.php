...
{
    /**
     * Expand the Slice 2 stub into the file-02 purchase request hub.
     */
    public function up(): void
    {
        ...
        Schema::table('purchase_requests', function (Blueprint $table) {
            ...
            $table->foreignId('current_handler_id')->nullable()->after('requester_id')->constrained('users')->nullOnDelete();
            ...
            $table->text('purpose')->nullable()->after('is_archived');
            ...
            $table->text('current_step_notes')->nullable()->after('pr_quarter');

            $table->boolean('has_ppmp')->default(false)->after('current_step_notes');
            $table->string('ppmp_reference')->nullable()->after('has_ppmp');

            $table->string('earmark_id')->nullable()->unique()->after('ppmp_reference');
            ...
            $table->string('resolution_number')->nullable()->unique()->after('earmark_object_expenditures');
